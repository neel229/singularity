...
INSERT INTO creator (
  ...
  $1, $2, $3, $4, $5, $6, $7, $8
) RETURNING id, first_name, last_name, user_name, password, email, time_registered, time_confirmed, preferred_currency_id, creator_stock, virgin_tokens_left
`
...
SELECT id, first_name, last_name, user_name, password, email, time_registered, time_confirmed, preferred_currency_id, creator_stock, virgin_tokens_left FROM creator
WHERE id = $1
LIMIT 1
`
